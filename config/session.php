...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Setting this value to true will prefix the cookie with "__Host-" so
    | it is only accepted over HTTPS and cannot be accessed by JavaScript.
    | This is an additional security measure for sensitive cookies.
    |
    */
